...
! calculation settings (with default)
    ...
    integer :: maxloop = 128                                      ! upper limit of convergence loops
    real(dp) :: conver_tol = 1E-7                                 ! convergence tolerence of energy
    integer :: nodiis = 9                                         ! initial iteration steps without any mixing
	integer :: subsp = 5                                          ! dimension of suboptimal subspace
    real(dp) :: nudge = 0.5                                       ! mix the generated coefficient and original coefiicient by residual
    !------------------<module Radiation>------------------
