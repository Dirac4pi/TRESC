...
!> generation of output file
  subroutine generate_output()
    ...
    write(60,"(A21 I4 '.' I2.2 '.' I2.2 '  ' I2 ':' I2.2)") &
    'Job execution start: ',values(1),values(2),values(3),values(5),values(6)
    ios = getcwd(wd)
    ...
    write(60,"(A)") "  TRESC is a molecular 2-component DKH2 Hartree-Fock "
    write(60,"(A)") "  self-consistent field calculation program, fragment "
    write(60,"(A)") "  contracted spherical-harmonic GTO basis by default."
    write(60,"(A)") "  All results default to Atomic Units (A.U.)."
    write(60,*)
    write(60,"(A)") "External modules:"
    write(60,"(A)") "  IFPORT: Intel Fortran portability library"
