...
non-periodic polyatomic systems under the Born¨COppenheimer approximation, it's designed to do all-electron single-configuration self-consistent 
field calculation based on the static 2-component DKH2 electronic Hamiltonian of a given molecule.<br>
...
* If the frontier orbitals are (nearly) degenerate, 2c-SCF results may be far from initial spin states due to the mixing of alpha 
and beta orbitals in degenerate space, try keyword `keepspin` to to avoid this as possible.
