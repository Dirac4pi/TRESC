...
use fundamentals
use Rysdata
DOUBLE PRECISION,parameter :: PIE4 = 0.78539816339744827900
DOUBLE PRECISION,parameter :: SMALLX_LIMIT = 3e-7
...
subroutine rys_roots(nroots, x, u, w)
    ...
    DOUBLE PRECISION,intent(out) :: u(5)
    DOUBLE PRECISION,intent(out) :: w(5)
    integer :: off
    integer :: i, err = 1
    DOUBLE PRECISION :: rt, t
    ...
    t = sqrt(PIE4/x)
        ...
        if (err /= 0) call terminate('Rys roots and weights calculation failed.')
end subroutine rys_roots

integer function rys_root1(X, roots, weights)

        DOUBLE PRECISION :: Y, F1
        DOUBLE PRECISION,intent(in) :: X
        DOUBLE PRECISION,intent(out) :: roots(1), weights(1)
        DOUBLE PRECISION :: E
...
integer function rys_root2(X, roots, weights)
        DOUBLE PRECISION,intent(in) :: X
        DOUBLE PRECISION,intent(out) :: roots(2), weights(2)
        DOUBLE PRECISION :: R12, R22, W22
        DOUBLE PRECISION :: RT1, RT2, WW1, WW2
        DOUBLE PRECISION :: F1, E, Y
...
integer function rys_root3(X, roots, weights)
        ...
        DOUBLE PRECISION,intent(in) :: X
        DOUBLE PRECISION,intent(out) :: roots(3), weights(3)
        DOUBLE PRECISION :: R13, R23, W23, R33, W33
...
integer function rys_root4(X, roots, weights)
        DOUBLE PRECISION,intent(in) :: X
        DOUBLE PRECISION,intent(out) :: roots(4), weights(4)
        DOUBLE PRECISION :: R14, R24, W24, R34, W34, R44, W44
...
integer function rys_root5(X, roots, weights)
        DOUBLE PRECISION,intent(in) :: X
        DOUBLE PRECISION,intent(out) :: roots(5), weights(5)
        DOUBLE PRECISION :: R15,R25,W25,R35,W35,R45,W45,R55,W55
