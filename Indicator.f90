...
! DO NOT use universal loop variables
    ...
    subroutine elec_stc_calc()
        ...
        character(len = 50) :: address_molecular = 'E:\TRESC\H2\H2.tip'
        character(len = 50) :: address_basis = 'E:\TRESC\H2\cc-pvtz-dk.0.gbs'
        ...
        deallocate(DIISmat)
        deallocate(ipiv)
        deallocate(oper3_history)
        deallocate(oper3_pre)
